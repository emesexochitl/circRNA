...
for i in xrange(0, len(reflist)):
    ...
    if hitlist == ['MeJa', 'Mock', 'SA', 'WT', 'dbr1-2']:
        n12345 = n12345 +1
    ...
    if hitlist == ['MeJa', 'dbr1-2']:
        n15 = n15 +1

    if hitlist == ['Mock', 'SA']:
        n23 = n23 +1

    if hitlist == ['Mock', 'dbr1-2']:
        n24 = n24 +1
    ...
    if hitlist == ['SA', 'dbr1-2']:
        n35 = n35 +1

    if hitlist == ['WT', 'dbr1-2']:
        n45 = n45 +1

    if hitlist == ['MeJa', 'Mock', 'SA']:
        n123 = n123 +1

    if hitlist == ['MeJa', 'Mock', 'WT']:
        n124 = n124 +1

    if hitlist == ['MeJa', 'Mock', 'dbr1-2']:
        n125 = n125 +1

    if hitlist == ['MeJa', 'SA', 'WT']:
        n134 = n134 +1

    if hitlist == ['MeJa', 'SA', 'dbr1-2']:
        n135 = n135 +1

    if hitlist == ['MeJa', 'WT', 'dbr1-2']:
        n145 = n145 +1

    if hitlist == ['Mock', 'SA', 'WT']:
        n234 = n234 +1

    if hitlist == ['Mock', 'SA', 'dbr1-2']:
        n235 = n235 +1

    if hitlist == ['Mock', 'WT', 'dbr1-2']:
        n245 = n245 +1

    if hitlist == ['SA', 'WT', 'dbr1-2']:
        n345 = n345 +1

    if hitlist == ['MeJa', 'Mock', 'SA', 'WT']:
        n1234 = n1234 +1

    if hitlist == ['MeJa', 'Mock', 'SA', 'dbr1-2']:
        n1235 = n1235 +1

    if hitlist == ['MeJa', 'Mock', 'WT', 'dbr1-2']:
        n1245 = n1245 +1

    if hitlist == ['MeJa', 'SA', 'WT', 'dbr1-2']:
        n1345 = n1345 +1

    if hitlist == ['Mock', 'SA', 'WT', 'dbr1-2']:
        n2345 = n2345 +1
