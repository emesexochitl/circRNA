...
class iso_set():
    ...
    def save_files(self):
        with  open('average_circ_exon_len_num.txt', 'a') as f:
            f.write("%s\t%.3f\t%.3f\t%.3f\n" % (self.iso_id, self.iso_num, self.total_len[0], self.av_len[0]))


try:
    os.remove("average_circ_exon_len_num.txt")
except:
    pass
...
exonlen_file = "ciri2.03_circ_isoform_man3.saf"
